...
using System.Web;
using Recurso5.Recurso1;
using Recurso5.Recurso2;
using Recurso5.Recurso3;
using Recurso5.Recurso4;
...
namespace Recurso5
{
    public static class ServicoConcorrencia
    {
        ...
        public static string Concorrer(int id, string regiao, int count)
        {
            ...
            else if (emExecucao || emRequisicao)
            {
                ...
                else
                {
                    ...
                    {
                        Debug.WriteLine($"5 - WebService {id} esperando resposta");
                    }
                    retorno = "OK";
                }
            }
        ...
        private static void WebService1()
        {
            ...
            filaRespondeu.Add(new Tuple<int, string>(1, ws1.Concorrer(5, "RC", countClient)));
        ...
        private static void WebService2()
        {
            ...
            filaRespondeu.Add(new Tuple<int, string>(2, ws2.Concorrer(5, "RC", countClient)));
        ...
        private static void WebService3()
        {
            ...
            filaRespondeu.Add(new Tuple<int, string>(3, ws3.Concorrer(5, "RC", countClient)));
        ...
        private static void WebService4()
        {
            ...
            filaRespondeu.Add(new Tuple<int, string>(4, ws4.Concorrer(5, "RC", countClient)));
        ...
        public static string ObterOK()
        {
            ...
            {
               Debug.WriteLine("Web api 5 esperando todas as respostas.");
            }
